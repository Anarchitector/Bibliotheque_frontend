...
import { BoxAuthorization, BtnBoxAuthorization, LinkComponent, PageComponent } from "./styles";
  ...
  return (
    <PageComponent>
      ...
      {!user.id && ( // Показываем блок авторизации только если пользователь не авторизован
        <BoxAuthorization>
          <span>To proceed with your order, you need to register or log in.</span>
          <BtnBoxAuthorization>
